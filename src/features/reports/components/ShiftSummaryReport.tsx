...
import { Table, Text, Badge, Loader, Center } from '@mantine/core';
import { DateRangePicker } from '@/components/common/DateRangePicker';
import type { DateRange } from '@/types/common';
import { formatMoney, formatVolume } from '@/lib/utils/money';
import { formatDateTime } from '@/lib/utils/dates';
import { useShiftSummaryReport } from '../api/reports.hooks';
...
export function ShiftSummaryReport() {
  ...
  const { data = [], isLoading } = useShiftSummaryReport(filters);
